...
sed -i "s|{version}|1.0.7|g" public/publish-fpk/docker/manifest
sed -i "s|{changelog}|1. 一些累计更新，写了一些新bug、2. #3|g" public/publish-fpk/docker/manifest
sed -i "s|{version}|v1.0.7|g" public/publish-fpk/docker/app/docker/docker-compose.yaml
