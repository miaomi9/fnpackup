...
sed -i "s|{version}|1.1.3|g" public/publish-fpk/docker/manifest
sed -i "s|{changelog}|1. 增加统一网关注册|g" public/publish-fpk/docker/manifest
sed -i "s|{version}|v1.1.3|g" public/publish-fpk/docker/app/docker/docker-compose.yaml
